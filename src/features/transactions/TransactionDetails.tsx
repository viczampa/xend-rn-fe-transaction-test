...
export function TransactionDetails({ bottomSheetRef, transaction: t }: Props) {
  ...
  const txHash = (t.raw.deposit_tx_hash ?? t.raw.destination_tx_hash) as string | null;
  const fromAddress = (t.raw.from_address ?? (t.source.details.address as string | null)) ?? null;
